...
return cljs.core.name.call(null,G__2288);
} else {
return G__2288;
}
});
...
var G__2289 = (i + (1));
var G__2290 = (obj__$1[cljs.core.nth.call(null,ks_STAR_,i)]);
i = G__2289;
obj__$1 = G__2290;
continue;
}
...
var temp__5737__auto__ = applied_science.js_interop.impl.get_value_by_keys.call(null,obj,cljs.core.butlast.call(null,ks_STAR_));
if((temp__5737__auto__ == null)){
return not_found;
} else {
